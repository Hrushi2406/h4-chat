...
const getSystemPrompt = (
  ...
  return `You are a helpful AI assistant. Give short, clear, concise, and well-formatted responses in markdown.
   ...
   Guidelines:
    ...
    - ${
      composioEnabled &&
      `You can use connected-app tools through Composio for email, calendar, drive, docs, spreadsheets, project management, developer workflows, CRM, payments, commerce, design, and Google Workspace tasks.
      ...
      For authorization or connection status, call ${COMPOSIO_META_TOOLS.MANAGE_CONNECTIONS} with valid toolkit slugs such as gmail, googlecalendar, googledrive, notion, linear, github, googledocs, googlesheets, outlook, hubspot, salesforce, confluence, stripe, shopify, or figma, then provide the Connect Link in chat and continue once the user confirms.
