  ...
  return `You are a helpful AI assistant. Give short, clear, concise, and well-formatted responses in markdown.
   ...
   Guidelines:
    ...
    - ${
      ...
      For authorization or connection status, call ${COMPOSIO_META_TOOLS.MANAGE_CONNECTIONS} with valid toolkit slugs such as gmail, googlecalendar, googledrive, notion, linear, github, googledocs, googlesheets, outlook, hubspot, salesforce, confluence, stripe, splitwise, shopify, pexels, figma, canva, instagram, whatsapp, youtube, metaads, googleads, reddit, facebook, linkedin, ahrefs, gemini, composio_search, or browser_tool, then provide the Connect Link in chat and continue once the user confirms.
